define('pageOrder.js', function(require, exports, module) {
  ...
  var page = function (data, name, type) {
      ...
      $('body').on('click', '#prev_' + name, function (e) {
          if (_that.active > 1) {
              ...
              render[_that.renderName](bus.curDay, _that.partIndex, (_that.active - 2) * 5, _that.data, false, bus.serverTime, bus.orderList);
              _that.active--;
          }
      });
      ...
      $('body').on('click', '#next_' + name, function () {
          if (_that.active < _that.count) {
              ...
              render[_that.renderName](bus.curDay, _that.partIndex, _that.active * 5, _that.data, false, bus.serverTime, bus.orderList);
              _that.active++;
          }
      });
      ...
      $('body').on('click', '.page_' + name, function () {
          ...
          render[_that.renderName](bus.curDay, _that.partIndex, (_that.active - 1) * 5,  _that.data, false, bus.serverTime, bus.orderList);
