define('pageTotal.js', function(require, exports, module) {
  ...
  var page = function (data, name, type) {
      ...
      $('body').on('click', '#prev_' + name, function (e) {
          if (_that.active > 1) {
              ...
              render[_that.renderName]((_that.active - 2) * 10, bus.totalLocation, _that.data);
              _that.active--;
          }
      });
      ...
      $('body').on('click', '#next_' + name, function () {
          if (_that.active < _that.count) {
              ...
              render[_that.renderName](_that.active * 10, bus.totalLocation, _that.data);
              _that.active++;
          }
      });
      ...
      $('body').on('click', '.page_' + name, function () {
          ...
          render[_that.renderName]((_that.active - 1) * 10, bus.totalLocation, _that.data);
