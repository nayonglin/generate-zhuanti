        ...
        bindEvent: function () {
            ...
            $('#live,#my_league').on('click', function () {
                ...
                if ($(this).hasClass("left")) { // 点击对决实况
                    ...
                    $('.text_my_league').attr('src', __uri("/img/text_my_league.png"));
                    $('.text_live').attr('src', __uri("/img/text_live_active.png"));
                    $('.my_league').removeClass("on");
                    $('.live').addClass('on');
                } else {
                    $('.league_and_live').removeClass('on_live').addClass('on_my_league');
                    $(this).addClass('on').prev().removeClass('on');
                    $('.text_my_league').attr('src', __uri("/img/text_my_league_active.png"));
                    $('.text_live').attr('src', __uri("/img/text_live.png"));
